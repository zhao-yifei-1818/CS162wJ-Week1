...
def quick_test_car_generate():
    # Test section: lets see if methods from Car-class works.
    ...
    while choice != 0:
        ...
        #2 look up the current one and give false solution
            ...
            if current_car != None:
                ...
                print("No car yet inputed for information look up, create(2) a car or quickstart(6) one first!. ")
        #3 Igniting, as one of the starting method
            ...
            if current_car != None:
                ...
                print("No car yet inputed for turning engine on, create(2) a car or quickstart(6) one first!. ")
        #4 Driving, this method just gives you a random location
        elif choice == 4:
            if current_car != None:
                print(current_car.drive())
            else:
                print("No car yet inputed for drive, create(2) a car or quickstart(6) one first!. ")
